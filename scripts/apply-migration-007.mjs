#!/usr/bin/env node
/**
 * Apply db/migrations/007_all_steps_link_enabled.sql using DATABASE_URL from .env.local.
 *
...
const sqlPath = path.join(__dirname, "..", "db", "migrations", "007_all_steps_link_enabled.sql");
...
try {
  ...
  console.log("Applied 007_all_steps_link_enabled.sql successfully.");
} finally {
  await client.end();
}
