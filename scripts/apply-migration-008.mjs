#!/usr/bin/env node
/**
 * Apply db/migrations/008_disable_links_selected_steps.sql using DATABASE_URL from .env.local.
 *
...
const sqlPath = path.join(__dirname, "..", "db", "migrations", "008_disable_links_selected_steps.sql");
...
try {
  ...
  console.log("Applied 008_disable_links_selected_steps.sql successfully.");
} finally {
  await client.end();
}
