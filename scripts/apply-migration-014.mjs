#!/usr/bin/env node
/**
 * Apply db/migrations/014_targetless_data_ingestion_slots.sql using DATABASE_URL from .env.local.
 *
...
const sqlPath = path.join(
  ...
  "db",
  "migrations",
  "014_targetless_data_ingestion_slots.sql",
);
...
try {
  ...
  console.log("Applied 014_targetless_data_ingestion_slots.sql successfully.");
} finally {
  await client.end();
}
