#!/usr/bin/env node
/**
 * Apply db/migrations/005_calibration_app_settings.sql using DATABASE_URL from .env.local.
 *
...
const sqlPath = path.join(__dirname, "..", "db", "migrations", "005_calibration_app_settings.sql");
...
try {
  ...
  console.log("Applied 005_calibration_app_settings.sql successfully.");
} finally {
  await client.end();
}
