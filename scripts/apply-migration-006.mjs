#!/usr/bin/env node
/**
 * Apply db/migrations/006_reason_jira_step_links.sql using DATABASE_URL from .env.local.
 *
...
const sqlPath = path.join(__dirname, "..", "db", "migrations", "006_reason_jira_step_links.sql");
...
try {
  ...
  console.log("Applied 006_reason_jira_step_links.sql successfully.");
} finally {
  await client.end();
}
