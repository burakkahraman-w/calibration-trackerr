#!/usr/bin/env node
/**
 * Apply db/migrations/003_calibration_owners.sql using DATABASE_URL from .env.local.
 *
...
const sqlPath = path.join(__dirname, "..", "db", "migrations", "003_calibration_owners.sql");
...
try {
  ...
  console.log("Applied 003_calibration_owners.sql successfully.");
} finally {
  await client.end();
}
