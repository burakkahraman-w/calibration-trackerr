#!/usr/bin/env node
/**
 * Apply db/migrations/009_calibration_vehicle_options.sql using DATABASE_URL from .env.local.
 *
...
const sqlPath = path.join(__dirname, "..", "db", "migrations", "009_calibration_vehicle_options.sql");
...
try {
  ...
  console.log("Applied 009_calibration_vehicle_options.sql successfully.");
} finally {
  await client.end();
}
